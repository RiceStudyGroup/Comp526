...
loadProgram() {
    ...
    insMEM[0] = 0x14420001;       // ADDI  R2, R2, 1            top:      index1++
    insMEM[1] = 0x10810000;       // LOAD R1, 0(R2)                   element1 = MEM[index1]
    insMEM[2] = 0x14840001;       // ADDI  R4, R4, 1                       index2++
    insMEM[3] = 0x10400000;       // LOAD R0, 0(R2)                       element2 = MEM[index2]
    insMEM[4] = 0x04012800;       // ADD R5, R0, R1                       temp = element1 + element2
    insMEM[5] = 0x18C50000;       // STORE R5, 0(R6)                      MEM[index3] = temp
    insMEM[6] = 0x14C60001;       // ADDI  R6, R6, 1                      index3++
    insMEM[7] = 0x1508FFFF;       // ADDI  R8, R8, -1                     count--
